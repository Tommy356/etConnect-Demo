...
static INLINE void
GSIArrayInsertItem(GSIArray array, GSIArrayItem item, size_t index)
{
  size_t	i;
...
static INLINE void
GSIArrayInsertItemNoRetain(GSIArray array, GSIArrayItem item, size_t index)
{
  size_t	i;
...
static INLINE GSIArrayItem
GSIArrayItemAtIndex(GSIArray array, size_t index)
{
#ifdef	GSI_ARRAY_CHECKS
  NSCAssert(index < array->count, NSInvalidArgumentException);
#endif
